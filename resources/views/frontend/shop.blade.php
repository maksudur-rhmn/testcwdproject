              ...
              <div class="tab-pane active" id="all">
                  <ul class="row">
                    ...
                    @foreach ($products as $product)
                      <li class="col-xl-3 col-lg-4 col-sm-6 col-12 {{ ($counter > 8) ? 'moreload' : '' }} ">
                  ...
                  <ul class="row">
                    @foreach ($category->product as $pro)
                      <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                          <div class="product-wrap">
                              <div class="product-img">
                                  <img src="{{ asset('uploads/products') }}/{{ $pro->product_thumbnail_image }}" alt="">
                                  <div class="product-icon flex-style">
                                      <ul>
                                          <li><a data-toggle="modal" data-target="#exampleModalCenter" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                          <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                              ...
                              <div class="product-content">
                                  <h3><a href="{{ route('product.show',$pro->product_slug) }}">{{ $pro->product_name }}</a></h3>
