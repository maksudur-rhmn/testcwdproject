    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        @if (Auth::user()->role == 1)
          ...
          <a href="{{ route('faq_index') }}" class="sl-menu-link @yield('faq')">
            <div class="sl-menu-item">
          ...
          <a href="{{ route('category.index') }}" class="sl-menu-link @yield('category')">
            <div class="sl-menu-item">
              <i class="fa fa-television tx-24"></i>
              <span class="menu-item-label">Category</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          <a href="{{ route('todolist.index') }}" class="sl-menu-link @yield('todolist')">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
              <span class="menu-item-label">To Do List</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          ...
          <a href="{{ route('blog.index') }}" class="sl-menu-link @yield('blogs')">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
